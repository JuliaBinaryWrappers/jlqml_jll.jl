# `jlqml_jll.jl` (v0.6.2+0)

[![deps](https://juliahub.com/docs/jlqml_jll/deps.svg)](https://juliahub.com/ui/Packages/General/jlqml_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/1d52cc94238a4f55cba383cd0b683e5d4df810cc/J/jlqml/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.

# `jlqml_jll.jl` (v0.6.1+1)

[![deps](https://juliahub.com/docs/jlqml_jll/deps.svg)](https://juliahub.com/ui/Packages/General/jlqml_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/f6f09f19784882703835e106f0a3f0dc97949ec2/J/jlqml/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
